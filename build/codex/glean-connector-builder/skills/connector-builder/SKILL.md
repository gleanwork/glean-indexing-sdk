...
- `connector-code-formatting`: maintainable handler, service, repository, parser, and model boundaries inspired by Conduit without copying Conduit-only runtime scaffolding.
