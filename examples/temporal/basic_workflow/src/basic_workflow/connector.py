"""Sample connector for the Temporal workflow example.

This is a simplified connector for demonstration purposes.
...
def create_connector(connector_name: str) -> SampleConnector:
    ...
    In production, this would look up connectors from a registry
    or instantiate based on configuration.
