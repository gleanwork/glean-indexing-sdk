...
try:
    from glean.indexing.observability.plugins.aws.cloudwatch_logs import (
        CloudWatchLogsProvider as CloudWatchLogsProvider,
    )
...
try:
    from glean.indexing.observability.plugins.aws.cloudwatch_metrics import (
        CloudWatchMetricsProvider as CloudWatchMetricsProvider,
    )
